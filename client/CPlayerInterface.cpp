...
void CPlayerInterface::heroInGarrisonChange(const CGTownInstance * town)
{
	...
	if(CCastleInterface * c = castleInt)
	{
		...
		c->garr->setArmy(town->getUpperArmy(), false);
		c->garr->setArmy(town->visitingHero, true);
...
void CPlayerInterface::serializeTempl(Handler & h, const int version)
{
...
void CPlayerInterface::showArtifactAssemblyDialog(ui32 artifactID, ui32 assembleTo, bool assemble, CFunctionList<bool()> onYes, CFunctionList<bool()> onNo)
{
	...
	if(assemble)
	{
		...
		text += str(boost::format(CGI->generaltexth->allTexts[732]) % assembledArtifact.Name());
...
int CPlayerInterface::getLastIndex(std::string namePrefix)
{
	...
	std::map<time_t, int> dates; //save number => datestamp
...
void CPlayerInterface::initMovement(const TryMoveHero & details, const CGHeroInstance * ho, const int3 & hp)
{
	if(details.end.x + 1 == details.start.x && details.end.y + 1 == details.start.y) //tl
	{
		...
		stable_sort(CGI->mh->ttiles[hp.x - 3][hp.y - 2][hp.z].objects.begin(), CGI->mh->ttiles[hp.x - 3][hp.y - 2][hp.z].objects.end(), objectBlitOrderSorter);
		stable_sort(CGI->mh->ttiles[hp.x - 2][hp.y - 2][hp.z].objects.begin(), CGI->mh->ttiles[hp.x - 2][hp.y - 2][hp.z].objects.end(), objectBlitOrderSorter);
		stable_sort(CGI->mh->ttiles[hp.x - 1][hp.y - 2][hp.z].objects.begin(), CGI->mh->ttiles[hp.x - 1][hp.y - 2][hp.z].objects.end(), objectBlitOrderSorter);
		stable_sort(CGI->mh->ttiles[hp.x][hp.y - 2][hp.z].objects.begin(), CGI->mh->ttiles[hp.x][hp.y - 2][hp.z].objects.end(), objectBlitOrderSorter);

		stable_sort(CGI->mh->ttiles[hp.x - 3][hp.y - 1][hp.z].objects.begin(), CGI->mh->ttiles[hp.x - 3][hp.y - 1][hp.z].objects.end(), objectBlitOrderSorter);

		stable_sort(CGI->mh->ttiles[hp.x - 3][hp.y][hp.z].objects.begin(), CGI->mh->ttiles[hp.x - 3][hp.y][hp.z].objects.end(), objectBlitOrderSorter);
	}
	...
	else if(details.end.x - 1 == details.start.x && details.end.y + 1 == details.start.y) //tr
	{
		...
		stable_sort(CGI->mh->ttiles[hp.x + 1][hp.y - 1][hp.z].objects.begin(), CGI->mh->ttiles[hp.x + 1][hp.y - 1][hp.z].objects.end(), objectBlitOrderSorter);

		stable_sort(CGI->mh->ttiles[hp.x + 1][hp.y][hp.z].objects.begin(), CGI->mh->ttiles[hp.x + 1][hp.y][hp.z].objects.end(), objectBlitOrderSorter);
	}
	...
	else if(details.end.x - 1 == details.start.x && details.end.y - 1 == details.start.y) //br
	{
		...
		stable_sort(CGI->mh->ttiles[hp.x - 2][hp.y + 1][hp.z].objects.begin(), CGI->mh->ttiles[hp.x - 2][hp.y + 1][hp.z].objects.end(), objectBlitOrderSorter);
		stable_sort(CGI->mh->ttiles[hp.x - 1][hp.y + 1][hp.z].objects.begin(), CGI->mh->ttiles[hp.x - 1][hp.y + 1][hp.z].objects.end(), objectBlitOrderSorter);
		stable_sort(CGI->mh->ttiles[hp.x][hp.y + 1][hp.z].objects.begin(), CGI->mh->ttiles[hp.x][hp.y + 1][hp.z].objects.end(), objectBlitOrderSorter);
		stable_sort(CGI->mh->ttiles[hp.x + 1][hp.y + 1][hp.z].objects.begin(), CGI->mh->ttiles[hp.x + 1][hp.y + 1][hp.z].objects.end(), objectBlitOrderSorter);
	}
...
void CPlayerInterface::finishMovement(const TryMoveHero & details, const int3 & hp, const CGHeroInstance * ho)
{
	...
	stable_sort(CGI->mh->ttiles[details.end.x - 2][details.end.y - 1][details.end.z].objects.begin(), CGI->mh->ttiles[details.end.x - 2][details.end.y - 1][details.end.z].objects.end(), objectBlitOrderSorter);
	stable_sort(CGI->mh->ttiles[details.end.x - 1][details.end.y - 1][details.end.z].objects.begin(), CGI->mh->ttiles[details.end.x - 1][details.end.y - 1][details.end.z].objects.end(), objectBlitOrderSorter);
	stable_sort(CGI->mh->ttiles[details.end.x][details.end.y - 1][details.end.z].objects.begin(), CGI->mh->ttiles[details.end.x][details.end.y - 1][details.end.z].objects.end(), objectBlitOrderSorter);

	stable_sort(CGI->mh->ttiles[details.end.x - 2][details.end.y][details.end.z].objects.begin(), CGI->mh->ttiles[details.end.x - 2][details.end.y][details.end.z].objects.end(), objectBlitOrderSorter);
	stable_sort(CGI->mh->ttiles[details.end.x - 1][details.end.y][details.end.z].objects.begin(), CGI->mh->ttiles[details.end.x - 1][details.end.y][details.end.z].objects.end(), objectBlitOrderSorter);
	stable_sort(CGI->mh->ttiles[details.end.x][details.end.y][details.end.z].objects.begin(), CGI->mh->ttiles[details.end.x][details.end.y][details.end.z].objects.end(), objectBlitOrderSorter);
}
...
void CPlayerInterface::acceptTurn()
{
	...
	{
		if(range::find(sleepingHeroes, hero) == sleepingHeroes.end())
		{
			heroToSelect = hero;
			break;
		}
...
void CPlayerInterface::showWorldViewEx(const std::vector<ObjectPosInfo> & objectPositions)
{
	...
	copy(objectPositions.begin(), objectPositions.end(), back_inserter(adventureInt->worldViewOptions.iconPositions));
