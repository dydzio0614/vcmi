...
static size_t impl_read(SDL_RWops * context, void * ptr, size_t size, size_t maxnum)
{
	auto stream = get_stream(context);
...
static size_t impl_write(SDL_RWops * context, const void * ptr, size_t size, size_t num)
{
