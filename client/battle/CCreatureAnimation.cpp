...
{
	auto func = bind(&getCreatureAnimationSpeed, creature, _1, _2);
...
template<int bpp>
void CCreatureAnimation::putPixelAt(SDL_Surface * dest, int X, int Y, size_t index, const std::array<SDL_Color, 8> & special) const
{
...
template<int bpp>
void CCreatureAnimation::putPixel(ui8 * dest, const SDL_Color & color, size_t index, const std::array<SDL_Color, 8> & special) const
{
	if(index < 8)
	{
